...
def normalise_input(user_input):
    ...
    # Separates individual words into a list
    inputList = no_punct.split()
    # Filters the words in the list so that insignificant words are ignored
    filtered_input_list = []
    filtered_input_list = filter_words(inputList, skip_words)
